<?php /* Template Name: Template Blog 1 
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-card-two">
                            <a href="blog-details.html">
                                <img src="<?php echo esc_url(get_template_directory_uri()."/images/blog-img10.jpg"); ?>" alt="Blog Images">
                            </a>
                            <div class="content">
                                <ul>
                                    <li><a href="author.html"> <i class="bx bx-user"></i>By Hellen </a></li>
                                    <li><i class="bx bx-calendar"></i> 23 April </li>
