<?php /* Template Name: Template Author 
                            ...
                            <ul class="navbar-nav m-auto">
                               ...
                               <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="author.html" class="nav-link active">
                                                Author
                                            </a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-12 col-md-12 text-center">
                                <div class="pagination-area">
                                    <a href="author.html" class="prev page-numbers">
                                        <i class="bx bx-chevron-left"></i>
                                    </a>
        
                                    <span class="page-numbers current" aria-current="page">1</span>
                                    <a href="author.html" class="page-numbers">2</a>
                                    <a href="author.html" class="page-numbers">3</a>
                                    
                                    <a href="author.html" class="next page-numbers">
                    ...
                    <div class="col-lg-4">
                        <div class="side-bar-area pl-20">
                            <div class="author-profile">
                                <img src="<?php echo esc_url(get_template_directory_uri()."/images/blog-user1.jpg"); ?>" alt="Images">
                                <h3>Ruth Dacus</h3>
                                <p>Hi, I am Ruth dacus freelancer based in New York, Web Development & Web Design remains one of my...</p>
