<?php /* Template Name: Template Register 
        ...
        <div class="user-area pt-100 pb-70">
            <div class="container">
                <div class="row align-items-center">
                            ...
                            <div class="contact-form">
                                ...
                                <form id="contactForm">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 ">
                                            <div class="form-group">
                                                <input type="email" name="name" id="name" class="form-control" required data-error="Please enter your Email" placeholder="Email">
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="user-img pl-20">
                            <img src="<?php echo esc_url(get_template_directory_uri()."/images/user-img.png"); ?>" alt="Images">
                        </div>
                    </div>
                </div>
            </div>
