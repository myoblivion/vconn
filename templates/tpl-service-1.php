<?php /* Template Name: Template Service 1 
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav m-auto">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            <a href="service-1.html" class="nav-link active">
                                                Services Style One
                                            </a>
                                        </li>
                                        <li class="nav-item">
        ...
        <!-- Inner Banner -->
        <div class="inner-banner inner-before2 inner-bg8">
            <div class="container">
                ...
                <div class="row justify-content-center pt-45">
                    <div class="col-lg-4 col-md-6">
                        <div class="services-card">
                            ...
                            <div class="top">
                                ...
                                <img src="<?php echo esc_url(get_template_directory_uri()."/images/services-top2.png"); ?>" alt="Images">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="services-card">
                            ...
                            <h3>
                                <a href="service-details.html">Bookkeeping</a>
                            </h3>
                            <p>
                                Lorem ipsum dolor sit amet, consecteturadipig elit, sed do eiusmod tempor incididunt utlit 
                                abore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida.lacus 
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="services-card">
                            ...
                            <h3>
                                <a href="service-details.html">Personal Assistance</a>
                            </h3>
                            <p>
                                Lorem ipsum dolor sit amet, consecteturadipig elit, sed do eiusmod tempor incididunt utlit 
                                abore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida.lacus 
