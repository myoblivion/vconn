<?php /* Template Name: Template Terms condition 
        ...
        <div class="terms-conditions-area pt-100 pb-70">
            <div class="container">
                <div class="section-title text-center">
                    <span class="sp-title">Terms & Conditions</span>
                    <h2>Vconn Terms & Conditions</h2>
                </div>
                <div class="row pt-45">
                    <div class="col-lg-12">
                        <div class="terms-conditions-img">
                            <img src="<?php echo esc_url(get_template_directory_uri()."/images/terms-condition-img.jpg"); ?>" alt="Images">
                        </div>
